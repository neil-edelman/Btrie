...
CC   := clang #gcc
CF   := -Wall -Wextra -pedantic -Weverything \
-Wno-comma -Wno-logical-op-parentheses -Wno-parentheses -Wno-poison-system-directories -Wno-documentation-unknown-command \
